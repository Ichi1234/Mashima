...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.208637,0.208637,0.208637,1.000000);//Base Color
	Material.VectorExpressions[3] = float4(0.208637,0.208637,0.208637,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,10.000000,0.000000,0.000000);//(Unknown) Roughness (Unknown) (Unknown)
