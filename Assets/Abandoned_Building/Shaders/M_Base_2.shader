...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.000000,0.833101,0.729167,0.000000);//Emissive Color
	Material.VectorExpressions[2] = float4(1.000000,0.833101,0.729167,0.000000);//(Unknown)
	Material.VectorExpressions[3] = float4(7.000000,5.831707,5.104169,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.279167,0.279167,0.279167,0.000000);//Base Color
	Material.VectorExpressions[6] = float4(0.279167,0.279167,0.279167,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(7.000000,0.000000,0.000000,0.000000);//Emmisive (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(Material.VectorExpressions[3].rgb,MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat(fmod(View.RealTime,2.00000000)));
	MaterialFloat3 Local1 = lerp(Local0,Material.VectorExpressions[4].rgb,MaterialFloat(Material.ScalarExpressions[0].y));

	PixelMaterialInputs.EmissiveColor = Local1;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.VectorExpressions[6].rgb;
