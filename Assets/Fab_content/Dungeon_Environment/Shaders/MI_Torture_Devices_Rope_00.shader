Shader "Unreal/MI_Torture_Devices_Rope_00"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.428571,0.000000);//Flatness (S) (Unknown) Brightness Desaturation
	Material.ScalarExpressions[1] = float4(4.386388,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
