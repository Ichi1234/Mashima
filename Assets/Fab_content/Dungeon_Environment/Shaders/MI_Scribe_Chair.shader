...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(-0.509689,0.000000,1.000000,0.523809);//Flatness (S) (Unknown) Brightness Desaturation
	Material.ScalarExpressions[1] = float4(6.054005,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
