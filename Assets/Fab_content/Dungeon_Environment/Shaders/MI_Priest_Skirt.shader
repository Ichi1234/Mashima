...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,0.000000,0.000000);//(Unknown) R (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 1);
