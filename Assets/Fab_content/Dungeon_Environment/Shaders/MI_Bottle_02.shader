...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.561905,0.000000);//Flatness (S) (Unknown) Brightness Desaturation
	Material.ScalarExpressions[1] = float4(1.000000,2.157485,0.000000,0.000000);//Metalness Roughness (Unknown) (Unknown)
