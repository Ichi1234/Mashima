Shader "Unreal/MI_Stone_Wall_00"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.750000,1.038042);//Tiling (Unknown) Brightness Roughness
	Material.ScalarExpressions[1] = float4(-16.049992,30.000000,3.000000,0.000000);//Offset Displacement Multiplier (Unknown)
}float3 GetMaterialWorldPositionOffset(FMaterialVertexParameters Parameters)
{
	...
	#endif
	MaterialFloat3 Local13 = (Material.ScalarExpressions[1].x * Parameters.TangentToWorld[2]);
	return Local13;;
}
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Local0, 2);
	...
	MaterialFloat3 Local8 = (Material.ScalarExpressions[0].z * Local6.rgb);
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 0);
	MaterialFloat Local12 = (Local10.g * Material.ScalarExpressions[0].w);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local8;
	PixelMaterialInputs.Metallic = Local10.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local12;
