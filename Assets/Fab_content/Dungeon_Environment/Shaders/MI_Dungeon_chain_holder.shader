Shader "Unreal/MI_Dungeon_chain_holder"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.600000,0.000000,0.000000);//(Unknown) Brightness (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local0 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	...
	MaterialFloat Local2 = MaterialStoreTexSample(Parameters, Local1, 2);
	...
	MaterialFloat3 Local7 = (Material.ScalarExpressions[0].y * Local5.rgb);
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 1);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 1);

	PixelMaterialInputs.EmissiveColor = Local3;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local7;
	...
	PixelMaterialInputs.AmbientOcclusion = Local9.r;
