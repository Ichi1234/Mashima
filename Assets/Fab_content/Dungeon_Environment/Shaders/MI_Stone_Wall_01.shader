Shader "Unreal/MI_Stone_Wall_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.300000,0.000000,1.000000,0.600000);//Tiling (Unknown) Brightness Roughness
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,3.000000,0.000000);//Offset Displacement Multiplier (Unknown)
