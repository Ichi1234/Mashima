...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(2.000000,0.000000,1.000000,0.987777);//Tiling (Unknown) Brightness Roughness
	Material.ScalarExpressions[1] = float4(0.000000,12.000000,5.000000,0.000000);//Offset Displacement Multiplier (Unknown)
