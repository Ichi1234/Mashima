...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.887923,0.723055,1.000000);//Tint
	Material.VectorExpressions[3] = float4(1.000000,0.887923,0.723055,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(-1.000000,0.000000,0.300000,0.000000);//Flatness (S) (Unknown) Brightness Desaturation
	Material.ScalarExpressions[1] = float4(0.533243,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local3 = lerp(Local1.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[0].x));
	...
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	MaterialFloat4 Local6 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	...
	MaterialFloat Local9 = dot(Local8, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local10 = lerp(Local8,MaterialFloat3(Local9,Local9,Local9),MaterialFloat(Material.ScalarExpressions[0].w));
	MaterialFloat3 Local11 = (Material.VectorExpressions[3].rgb * Local10);
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 0);
	MaterialFloat4 Local13 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local14 = MaterialStoreTexSample(Parameters, Local13, 0);
	MaterialFloat Local15 = (Material.ScalarExpressions[1].x * Local13.g);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local11;
	PixelMaterialInputs.Metallic = Local13.b;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local15;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local13.r;
