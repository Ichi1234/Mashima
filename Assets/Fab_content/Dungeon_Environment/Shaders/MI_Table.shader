...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.609524,-0.495238);//Flatness (S) (Unknown) Brightness Desaturation
	Material.ScalarExpressions[1] = float4(1.000000,1.266557,0.000000,0.000000);//Metalness Roughness (Unknown) (Unknown)
