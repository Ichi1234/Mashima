Shader "Unreal/MI_Torture_Devices_Breaking_Wheel"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,1.000000,0.000000);//Flatness (S) (Unknown) Brightness Desaturation
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
