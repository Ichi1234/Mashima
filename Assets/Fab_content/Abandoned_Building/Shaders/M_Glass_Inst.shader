...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[0].y;
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Material.ScalarExpressions[0].z,Material.ScalarExpressions[0].w);
